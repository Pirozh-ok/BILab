        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sex = table.Column<int>(type: "int", nullable: false, defaultValue: 2),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CancelingReasone = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Records", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Records_Adresses_AdressId",
                        column: x => x.AdressId,
                        principalTable: "Adresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Records_Procedures_ProcedureId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Records_Users_EmployerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Records_ProcedureId",
                table: "Records",
                column: "ProcedureId");

            migrationBuilder.CreateIndex(
                name: "IX_Schedules_TypeOfDayId",
                table: "Schedules",
                column: "TypeOfDayId");
