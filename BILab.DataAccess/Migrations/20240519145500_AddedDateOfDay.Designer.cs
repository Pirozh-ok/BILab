...
namespace BILab.DataAccess.Migrations
{
    ...
    [Migration("20240519145500_AddedDateOfDay")]
    partial class AddedDateOfDay
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BILab.Domain.Models.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("db291ef2-45a6-4ac4-841f-84a84f7adf11"),
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("e09317f8-87ab-4024-9048-5779bd03677a"),
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = new Guid("1058dab4-f5da-43f3-b072-a8ed6c8607b2"),
                            Name = "Employee",
